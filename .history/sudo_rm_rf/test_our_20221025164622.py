...
save_path = '/dsi/gannot-lab/datasets/mordehay/Result/test_for_git/Test_Sudo_data_partial_overlap_wham_ConstLr_8k/'
...
if GPU:
    ...
    if our_parameters:
        ...
        sudorm_model_path = "/home/dsi/moradim/sudo2/checkpoints/improved_sudo_epoch_70" ####the path to the parameters
