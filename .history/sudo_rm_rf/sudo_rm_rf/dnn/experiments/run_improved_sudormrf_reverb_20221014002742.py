...
file_handler = logging.FileHandler('/home/dsi/moradim/sudo/logfile.log', mode='w')  # mode='w'
...
num_workers = 8
data_loader = Old_Partial_DataLoader(csv_file, cds_lables, batch_size, shuffle=True, validation_split=0.999, num_workers=1)
...
len_valid_data_loader = len(0valid_data_loader)
