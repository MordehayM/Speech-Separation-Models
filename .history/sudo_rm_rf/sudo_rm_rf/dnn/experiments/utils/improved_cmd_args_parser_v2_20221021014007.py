...
def get_args():
    ...
    parser.add_argument("-elp", "--experiment_logs_path", type=str,
                        ...
                        default="/home/dsi/moradim/sudo_paper_lr_k41_16k/")
    parser.add_argument("-clp", "--checkpoints_path", type=str,
                        help="""Path for logging checkpoints.""",
                        default="/home/dsi/moradim/sudo_paper_lr_k41_16k/checkpoints/")
    parser.add_argument("--path_data", type=str,
                        help="""Path for the data to bu running.""",
                        default="/dsi/gannot-lab/datasets/mordehay/data_wham_partial_overlap/train/csv_files/with_wham_noise_res.csv")
