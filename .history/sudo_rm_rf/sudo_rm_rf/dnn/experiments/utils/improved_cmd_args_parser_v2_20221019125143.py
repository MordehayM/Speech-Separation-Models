...
def get_args():
    ...
    parser.add_argument("--path_data", type=str,
                        help="""Path for the data to bu running.""",
                        default="/dsi/gannot-lab/datasets/mordehay/data_wham_partial_Libri_RandSir/train/csv_files/with_wham_noise_res.csv")
    # ===============================================
