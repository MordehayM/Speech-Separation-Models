...
Path(hparams['experiment_logs_path']).mkdir(parents=True, exist_ok=True)
file_handler = logging.FileHandler(hparams['experiment_logs_path'] + 'logfile.log', mode='w')  # mode='w'
