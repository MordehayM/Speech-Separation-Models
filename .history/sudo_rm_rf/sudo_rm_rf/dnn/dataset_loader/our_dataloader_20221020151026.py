...
class Old_Partial_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        with open(record_path, "rb") as f:
            ...
            #for wham dataset
            #for wham dataset
            ix_without_noise, noisy_signal, _, speakers_target, s_thetas_array = pickle.load(f) #for delayed speakers, shlomi. also for partial wham
        ...
        mix_without_noise = librosa.resample(mix_without_noise, orig_sr=16000, target_sr=8000)"""
        #noisy_signal = librosa.resample(noisy_signal, orig_sr=16000, target_sr=8000)
        #speakers_target = librosa.resample(speakers_target, orig_sr=16000, target_sr=8000)
...
class Old_Partial_DataLoader(BaseDataLoader):
    ...
    """
    def __init__(self, csv_file, cds_lables, batch_size, shuffle=True, validation_split=0.2, num_workers=4):
