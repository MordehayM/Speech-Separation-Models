...
save_path = '/dsi/gannot-lab/datasets/mordehay/Result/test_for_git/Test_Sudo_data_partial_overlap_wham_sudo1_theirParameters/'
...
if GPU:
    ...
    if our_parameters:
        ...
        sudorm_model_path = "/home/dsi/moradim/sudo/checkpoints/improved_sudo_epoch_30" ####the path to the parameters
    ...
    for i, path in tqdm(enumerate(pathes_file[:3000])):
        ...
        with torch.no_grad():
            ...
            y_sudorm = sudorm_model(input_mix.unsqueeze(1).to('cuda:0'))
