...
if GPU:
    ...
    path_data = list(pd.read_csv("/dsi/gannot-lab/datasets/whamr/data/whamr_tt_16khz_max_len10.csv")["path"]) #"/dsi/gannot-lab/datasets/whamr/wav16k/max/tt/mix_both_reverb/*.wav"
    pathes_file = glob.glob(path_data)
    si_sdrs = []
