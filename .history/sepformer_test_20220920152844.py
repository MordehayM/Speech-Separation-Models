...
def save_audio(path, separated_signals, target, save_path, samplerate):
    ...
    subprocess.run(["cp", path, save_path])
...
si_sdrs = []
save_path = "/dsi/gannot-lab/datasets/mordehay/Result/test_for_git/Sepformer_Whamr_tt16kmax"
