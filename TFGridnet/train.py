...
def main(config):
    ...
    wandb.init(project="sep-ablation", entity="ren_mor")
...
if __name__ == '__main__':
    ...
    # config_without_vad_learnable_encoder-decoder.json
    # config_without_vad.json
    args.add_argument('-c', '--config', default="config_without_vad_learnable_encoder-decoder.json",
                      type=str,
